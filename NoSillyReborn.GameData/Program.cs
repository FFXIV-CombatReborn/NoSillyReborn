...
using NoSillyReborn.GameData;
using NoSillyReborn.GameData.Getters;
using NoSillyReborn.GameData.Getters.Actions;
using System.Net;
using System.Resources.NetStandard;

/// <summary>
/// Entry point for the NoSillyReborn GameData program.
/// </summary>
public class Program
{
    ...
    public static async Task Main()
    {
        try
        {
            ...
            var resourcePath = Path.Combine(dirInfo.FullName, "NoSillyReborn.SourceGenerators\\Properties\\Resources.resx");
